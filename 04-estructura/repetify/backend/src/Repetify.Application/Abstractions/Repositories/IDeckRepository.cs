...
namespace Repetify.Application.Abstractions.Repositories
{
	...
	public interface IDeckRepository
	{
		...
		/// <param name="deckId">The identifier of the deck to add the card to.</param>
		/// <returns>A task representing the asynchronous operation.</returns>
		Task AddCardAsync(Card card, Guid deckId);
		...
		/// <returns>A task representing the asynchronous operation.</returns>
		void UpdateCardAsync(Card card, Guid deckId);
